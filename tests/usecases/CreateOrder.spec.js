...
const CreateOrder_1 = require("../../src/usecases/CreateOrder");
describe('CreateOrder usecase', () => {
    it('should create an order with generated id and timestamp', async () => {
        const mockRepo = { create: jest.fn().mockImplementation((o) => Promise.resolve(o)) };
        const idGen = () => 'fixed-id-123';
        const nowFn = () => '2025-11-04T00:00:00.000Z';
        const uc = new CreateOrder_1.CreateOrder(mockRepo, idGen, nowFn);
